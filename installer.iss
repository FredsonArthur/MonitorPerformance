...
Source: "dist\MonitorPerformance_v1.1.4\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
...
[Run]
Filename: "{app}\MonitorPerformance_v1.1.4.exe"; Description: "{cm:LaunchProgram,Monitor de Performance}"; Flags: nowait postinstall skipifsilent